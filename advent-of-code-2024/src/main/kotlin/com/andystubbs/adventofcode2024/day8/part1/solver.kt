package com.andystubbs.adventofcode2024.day8.part1
...
fun main() {
    ...
    val input = readInput("/day8/part2/example.txt")
...
fun calculateAntiNodes(location1: Location, location2: Location, grid: List<List<Char>>): List<Location> {
    ...
    val antiNode = location1.addDifference(difference)
    if(!locationOutOfBounds(antiNode, grid)) result.add(antiNode)
    return result
}
