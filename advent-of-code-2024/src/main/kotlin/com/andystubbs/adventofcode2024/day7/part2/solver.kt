package com.andystubbs.adventofcode2024.day7.part2

import com.andystubbs.adventofcode2024.util.readInput

fun main() {

    val input = readInput("/day7/part2/input.txt")
...
fun concat(total: Long, operand: Long): Long {

    return "$total$operand".toLong()
}
